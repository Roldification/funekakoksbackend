		...
		<div>
    	 ...
    	 <div style="height:150px; width:360px; position:absolute; left:25px; padding-top:10px;">
    	 		...
    	 		<table style="width:100%; margin-top:10px;">
	    	 		...
	    	 		<tr>
	    	 			<td style="border-bottom:1px solid black; text-align:center;" ><font face="segoeui" style="font-size: 14px;">VIVELYN D. FRONTERAS</font></td> 
	    	 		</tr>
	    	 		<tr>
	    	 			<td><font face="segoeui" style="font-size: 9px;">Chief Operations Officer</font></td> 
	    	 		</tr>
    	 		</table>
    	 </div>
    	 
    	 <div style="height:305px; width:390px; padding-top:10px; position:absolute; left:395px;">
